        ...
        <Box component="main" sx={{ flexGrow: 1, py: 4 }}>
            <Container>
                ...
                <Typography variant="h6" align="center" color="textSecondary" gutterBottom>
                    Your one-stop solution for buying and selling everything you need!
                </Typography>

                <Box display="flex" justifyContent="center" gap={2} my={4}>
                    <Button variant="contained" size="large" sx={{ bgcolor: '#748CAB' }}>
                        Login
                    </Button>
                    ...
                    <Grid2 xs={12} sm={6} md={4}>
                        <Card sx={{ textAlign: 'center' }}>
                            ...
                            <CardContent>
                                ...
                                <Typography color="textSecondary">
                                    Reach a vast audience and grow your business effortlessly.
                                </Typography>
                            </CardContent>
                        </Card>
                    </Grid2>
